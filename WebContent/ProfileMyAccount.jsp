...
<body>
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<div class="pull-right">
					<ul class="nav">
						<li><span id="connecte">Bienvenue <a
								href="myaccount.html">M. Benoit Ricaud</a>
						</span>
						</li>
	...
	<div class="page-canvas">
		...
		<div class="container">
			...
			<h1>S'abonner au service itinélib'</h1>
				...
				<div class="span11 spanOffset1">
					...
					<ul id="monEspaceTab" class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#accueil"><i
								class="icon-home"></i> Accueil</a>
						</li>
						<li><a data-toggle="tab" href="#monCompte"><i
								class="icon-user"></i> Gérer mon compte</a>
						</li>
						<li><a data-toggle="tab" href="#mesReservations"><i
								class="icon-book"></i> Mes réservations</a>
						</li>
					</ul>
					<!-- FIN MONESPACETAB -->
				</div>
							...
							<div class="tab-content">
								...
								<div id="mesInformations" class="tab-pane active">
										...
										<div class="accordion-group">
											<div class="accordion-heading">
												<a class="accordion-toggle"
													...
													<h4><i class="icon-home"></i> Mes coordonnées</h4> 
													Benoit Ricaud 23, rue Armengaud 92210 Saint-Cloud</a>
											</div>
												...
												<div class="accordion-inner">
													...
													<form class="form-horizontal">
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="input-xlarge" id="prenom">
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="input-xlarge" id="nom">
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="input-xlarge" id="adresse">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="codePostal">Code
																Postal:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="codePostal">
															</div>
														</div>
												...
												<div class="accordion-inner">
													...
													<form class="form-horizontal">
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="input-xlarge" id="titulaire">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="codeBanque">Code
																Banque:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="codeBanque">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="codeGuichet">Code
																Guichet:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="codeGuichet">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="numCompte">N°
																de compte:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="numCompte">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="cleRib">Clé
																RIB:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="cleRib">
															</div>
														</div>
									...
									<div id="accordionMonMdp" class="accordion">
										<div class="accordion-group">
											<div class="accordion-heading">
												<a class="accordion-toggle" href="#collapseMonMdpFormulaire"
												...
												<div class="accordion-inner">
													...
													<form class="form-horizontal">
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="input-xlarge" id="actuelMdp">
															</div>
														</div>
														...
														<div class="control-group">
															<label class="control-label" for="nouveauMdp">Nouveau
																mot de passe:</label>
															<div class="controls">
																<input type="text" class="input-xlarge" id="nouveauMdp">
															</div>
														</div>

														<div class="control-group">
															<label class="control-label" for="nouveauMdpConfirmation">Confirmez
																mot de passe:</label>
															<div class="controls">
					...
					<div class="row">
						...
						<div class="span3 spanOffset1">
							...
							<div class="tabbable tabs-left">
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab"
										href="#voirReservations">Voir mes réservations</a>
									</li>
